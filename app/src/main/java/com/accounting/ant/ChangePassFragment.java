...
public class ChangePassFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextInputEditText txtOldPass,txtnewPass,txtconPass;

        txtOldPass = root.findViewById(R.id.txtOldPass);
        txtnewPass = root.findViewById(R.id.txtNewPass);
        txtconPass = root.findViewById(R.id.confirmPass);



        CheckBox checkBox = root.findViewById(R.id.showPassword);
        checkBox.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if(isChecked){
                ...
                txtconPass.setTransformationMethod(HideReturnsTransformationMethod.getInstance());

                checkBox.setText(R.string.hide_pass);
            }else{
                ...
                txtconPass.setTransformationMethod(PasswordTransformationMethod.getInstance());
